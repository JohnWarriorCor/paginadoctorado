...
export class ListadoService {
  listadoRegistroURL =
    "https://doctoradocienciasdelasaludusco.firebaseio.com/listadoEstudiantes.json";
  listadoURL =
    "https://doctoradocienciasdelasaludusco.firebaseio.com/listadoEstudiantes/";
  ...
  nuevoListado(listado: Listado) {
    ...
    return this.http.post(this.listadoRegistroURL, body, { headers }).pipe(
      map((res) => {
