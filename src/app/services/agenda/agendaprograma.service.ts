...
export class AgendaprogramaService {
  agendaRegistroURL =
    "https://doctoradocienciasdelasaludusco.firebaseio.com/agendaprograma.json";
  agendaURL =
    "https://doctoradocienciasdelasaludusco.firebaseio.com/agendaprograma/";
  private dbPath = "/agendaprograma";
  ...
  nuevoAgenda(agenda: Agenda) {
    ...
    return this.http.post(this.agendaRegistroURL, body, { headers }).pipe(
      map((res) => {
        return res.json();
      })
    );
