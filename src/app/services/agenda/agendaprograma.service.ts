...
export class AgendaprogramaService {
  agendaRegistroURL = 'https://doctoradocienciasdelasaludusco.firebaseio.com/agendaprograma.json';
  agendaURL = 'https://doctoradocienciasdelasaludusco.firebaseio.com/agendaprograma/';
