...
export class GruposinvestigacionService {
  gruposInvestigacionRegistroURL =
    'https://doctoradocienciasdelasaludusco.firebaseio.com/gruposInvestigacion.json';
  gruposInvestigacionURL =
    'https://doctoradocienciasdelasaludusco.firebaseio.com/gruposInvestigacion/';
  ...
  nuevoGrupo(grupoInvestigacion: Gruposinvestigacion) {
    ...
    return this.http
      .post(this.gruposInvestigacionRegistroURL, body, { headers })
      .pipe(
        map((res) => {
  ...
  getGrupos() {
    return this.http
      .get(this.gruposInvestigacionRegistroURL)
